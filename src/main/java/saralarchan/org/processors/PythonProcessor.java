...
public class PythonProcessor extends GenericActionProcessor {
  ...
  protected static String invokeScript(String func, ArrayList args) {
	if ( engine == null) {
		LogManager.logInfo("python Engine not initialised");
		return "";
	}
	 
  	return PyInterface.invokeFunction(engine, func, args.toArray());
  }
}
